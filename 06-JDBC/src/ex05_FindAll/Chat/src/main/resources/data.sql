insert into chat.User(user_login, user_password) values ('user1', 'password1');
insert into chat.User(user_login, user_password) values ('user2', 'password2');
insert into chat.User(user_login, user_password) values ('user3', 'password3');
insert into chat.User(user_login, user_password) values ('user4', 'password4');
insert into chat.User(user_login, user_password) values ('user5', 'password5');
